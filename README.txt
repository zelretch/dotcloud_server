The server is configured for dotcloud server.
...
response format: an array of json objects with two fields: id and score.

example: "[{\"id\":112652479837110273,\"score\":35},{\"id\":112652479837110273,\"score\":35}]"